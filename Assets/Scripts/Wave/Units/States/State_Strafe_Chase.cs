...
public class State_Strafe_Chase : State
{
    ...
    public State_Strafe_Chase(UnitBase owner) : base(owner.gameObject)
    {
        m_ownerUnit = owner;
    }
    ...
    public override void Update()
    {
        ...
        if (!m_ownerUnit.IsPathObstructed(dirToTarget, dirToTarget.magnitude))
        {
